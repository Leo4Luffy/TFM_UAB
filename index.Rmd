---
### Title page
title: "Colocar el titulo del TFM aquí" # The main title of your thesis (not including possible subtitles)
...
author: "Jorge Leonardo López Martínez" # Your full name (including middle names if applicable)
date: "Colocar aquí la fecha de la defensa" # Your defense date in Dutch: "[weekday] [day in numerics] [name of month] [year]"
#aula: true # set to true if your defense is in the Aula; set to false/omit if it is in the Agnietenkapel
time: "colocar la hora aquí" # time of your defense (a 24h time, e.g. "14.00")
#birthplace: "Barcelona" # your place of birth, in Dutch
#country_of_birth: "España" # if your birthplace is not in the Netherlands, fill in the country as well (in Dutch). Omit otherwise!
...
license: "Creative Commons Attribution-NonCommercial-ShareAlike 4.0 International License" # optional, otherwise this bit is omitted
