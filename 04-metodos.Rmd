...
Para identificar el efecto sobre la predictibilidad del número de datos de genotipado de SNP y del número de individuos genotipados, se usaron diferentes subconjuntos de datos (Figura 4.4) con la siguientes características:

1. Distinta cantidad de individuos genotipados:
...
::: {.center data-latex=""}
__Figura 2.4:__ Esquema de construcción de la matriz H a partir de la matriz A y y la matriz G, con base en diferentes subconjuntos de datos (o matrices G). El recuadro 1 representa tres matrices G con distinta dimensión dado el número de individuos genotipados y el recuadro 2 representa tres diferentes densidades de SNP, para cada uno de las tres matrices del recuadro 1.
:::
