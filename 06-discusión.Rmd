...
Como solución a estos problemas se desarrolló el ssGBLUP, el cual es un método de selección donde la información genómica se extiende a los individuos sin genotipo a partir de una matriz de parentesco combinada con información de genotipos y del pedigrí [@cite:17; @cite:16], denominada como matriz H. En vista a esto, consideramos que la selección genómica mediante el ssGBLUP puede ser una opción interesante para la mejora genética en el arroz, además que a partir del uso de esta metodología se puede obtener predicciones más precisas a través de una mejor estimación del parentesco entre individuos, y estimaciones más precisas de los parámetros genéticos [@cite:76].
