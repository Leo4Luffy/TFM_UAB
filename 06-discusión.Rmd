...
En relación a lo anteriormente mencionado, @cite:58 y @cite:88 afirman que en los programas de mejora genética (en plantas y en animales), no siempre son posibles grandes conjuntos de entrenamiento, y una forma de resolver este problema consiste en diseñar estrategias de genotipado para optimizar la composición de un conjunto de entrenamiento con el que se pueda lograr una buena precisión en la predicción.

Al comparar el BLUP convencional (esto es, los casos en los que se consideró densidad de marcador de 0 y ningún individuo genotipado) con el ssGBLUP, nuestros resultados mostraron que el ssGBLUP superó al BLUP en términos de precisión de la predicción. Con relación a esto, los beneficios de incluir información de genotipos en la precisión de la predicción se ha informado en otros estudios. Para caracteres de calidad en cítricos, @cite:20 informaron una mejor precisión a partir del uso de información genómica, lo que según los mismos autores demuestra el potencial del ssGBLUP para la mejora genética de frutas. @cite:72, usando proporciones diferentes de individuos genotipados (0%, 25%, 50%, 75% y 100%), encontraron un aumento en la precisión de la predicción por encima del 3% y del 6% para la altura del árbol y la densidad de la madera, respectivamente. . El aumento en la precisión de la predicción se debe a que, a diferencia del ssGBLUP, el BLUP asume ninguna relación entre individuos fundadores [@cite:71], e ignora el término del muestreo Mendeliano [@cite:72; @cite:89].

<!--
Ejemplo en articulo de Hidalgo et al, para comparar precisión sin y con uso de la información genómica... Los beneficios de incluir información genómica en la precisión de la predicción se han informado en varias especies y características. Wolc et al. (2011) indicó un aumento promedio de ~17% para predicciones de 16 rasgos en capas. Lourenço et al. (2015) estimó un aumento de ~50 % en la precisión de las predicciones de crecimiento y características relacionadas con la eficiencia en pollos de engorde. Vallejo et al. (2017) afirmaron que la información genómica duplicó la precisión de las predicciones de resistencia a enfermedades en la trucha arcoíris. García et al. (2018) encontraron que la información genómica aumentó la precisión hasta en un 36 % para las predicciones del peso residual de la canal en el bagre de canal. En bovinos de doble propósito, Cesarani et al. (2020)encontró un aumento del 37% en la precisión de las predicciones de ordeñabilidad. Macedo et al. (2020a) informaron un aumento en la precisión de ~33 % para las predicciones de producción de leche en una población de ovejas. Berman et al. (2020) informaron un aumento del 15 % en la precisión de las predicciones de mortalidad en pollos de engorde.

Los aumentos en la precisión se atribuyen a una estimación más precisa de los términos de muestreo mendelianos ( Hayes et al., 2009 ; Cole y VanRaden, 2011 ). La magnitud del aumento en la precisión de las predicciones genómicas depende del número, distribución y contribución de los genotipos y fenotipos, así como de la intensidad de selección de los caracteres ( Lourenco et al., 2015 ). En nuestro estudio, el aumento en la precisión por la inclusión de genotipos fue mayor que en la mayoría de los estudios anteriores, lo que puede explicarse por la gran cantidad de fenotipos y genotipos disponibles en esta población de pollos de engorde.

Cuando no se incluyeron aves con genotipo en las poblaciones de entrenamiento, la disminución promedio en la precisión de los valores genéticos estimados entre características y poblaciones de entrenamiento fue del 41 % de la progenie a la gran progenie, del 60 % de la progenie a la gran progenie y del 51 % de la gran progenie a la progenie. gran gran descendencia. Por el contrario, la precisión de los valores reproductivos estimados se redujo en un 14 % de progenie a gran progenie, en un 17 % de progenie a gran gran progenie y solo en un 3 % de gran progenie a gran gran progenie cuando las poblaciones de entrenamiento incluían aves con genotipo ( Figura 1 ). Habier et al. (2007) reportaron resultados similares al comparar varios métodos de estimación de valores genéticos. En su estudio, la persistencia de las precisiones de los métodos basados en la genómica siempre fue mayor que la de los métodos basados en el pedigrí.

Las precisiones en las poblaciones de validación disminuyeron más rápido sin aves genotipadas que con aves genotipadas en las poblaciones de entrenamiento (primeros 3 años de datos), lo que sugiere que los efectos de los segmentos cromosómicos independientes se estimaron con mayor precisión en el último caso. Según Bastiansen et al. (2012), las relaciones de pedigrí no pueden predecir la segregación aleatoria de segmentos cromosómicos independientes a las siguientes generaciones, mientras que esta segregación puede rastrearse mediante marcadores. Por lo tanto, la proporción de la variación genética explicada por el desequilibrio de ligamiento con marcadores decae menos que la proporción de la variación genética explicada por la estructura familiar. Cuando los individuos en las poblaciones de entrenamiento y validación están relacionados, compartirán más segmentos cromosómicos, minimizando la pérdida de precisión de las poblaciones de entrenamiento a validación; además, si los datos son lo suficientemente grandes como para estimar con precisión el efecto de los segmentos cromosómicos independientes que se segregan en la población, la persistencia será alta a lo largo de varias generaciones.
-->
