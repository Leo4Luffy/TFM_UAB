...
Los conjuntos de datos genotípicos y fenotípicos usados en este estudio se obtuvieron del [Rice SNP-Seek Database](https://snp-seek.irri.org/index.zul;jsessionid=DD991975FDC4F320BE3C33ED056D0363), el cual es un cibersitio donde se proporciona información sobre datos de genotipos y de fenotipos de distintas variedades de arroz (_Oryza sativa L._).
...
::: {.center data-latex=""}
__Figura 2.1:__ Estructura poblacional de datos de arroz. A saber, los puntos y las circuferencias de color representan los distintos grupos varietales de arroz: tipo intermedio o mezclado (ADM), aromático (ARO), aus (AUS), indica (IND) y japónica (JAP).
:::
