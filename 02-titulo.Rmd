...
varU_ped1 <- ggplot(data = varU_ped_1, aes(x = varU)) +
  ...
  annotate(geom = 'text', x = 0.48, y = 15, label = TeX('$(0.36; 0.51)$'), size = 4.8) +
...
varE_ped1 <- ggplot(data = varE_ped_1, aes(x = varE)) +
  ...
  annotate(geom = 'text', x = 0.20, y = 25, label = TeX('$(0.13; 0.23)$'), size = 4.8) +
...
h2_ped1 <- ggplot(data = h2_ped_1, aes(x = h2)) +
  ...
  annotate(geom = 'text', x = 0.77, y = 15, label = TeX('$(0.62; 0.79)$'), size = 4.8) +
