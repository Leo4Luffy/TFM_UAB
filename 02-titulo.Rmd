...
Para identificar el efecto sobre la predictibilidad del tamaño de la muestra de entrenamiento, el número de datos de genotipado de SNPs, el número de individuos genotipados y el método estadístico, se usaron diferentes subconjuntos de datos (Figura 2.4):
...
Puntos <- data.frame(x = c(3.5, 6.1, 8.1), y = c(6.1, 5.4, 0.4))
...
data.frame(
  ...
  annotate(geom = 'text', x = 6.1, y = 5.4, label = '2', family = 'gochi', size = 5.8, colour = 'black') +
  ...
  annotate(geom = 'text', x = 9.5, y = 2.3, label = '2', family = 'gochi', size = 5.8, colour = 'black') +
  ...
  annotate(geom = 'text', x = 14.75, y = 1.94, label = 'reml', size = 4.6, colour = 'black') +
  annotate(geom = 'text', x = 14.25, y = 1.94, label = 'RKHS', size = 4.6, colour = 'black', angle = 90) +
