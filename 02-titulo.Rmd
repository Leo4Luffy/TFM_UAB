...
Si bien el proceso anterior de selección genómica tiene ventajas como lo son (ESCRIBIR LAS VENTAJAS Y CITAR), también se le considera como un proceso torpe [@cite:15] que lleva consigo una serie de inconvenientes como son la perdida de información y la difícultad de generalizarse a caracteres múltiples y maternos [@cite:17; @cite:15]. Conscientes de esto, Legarra, Aguilar y Misztal (2009) simplificaron el proceso de varios pasos al desarrollar un método de evaluación conjunta utilizando toda la información fenotípica, de pedigrí y genómica, método que estos mismos autores denominaron como selección genómica de un solo paso (comunmente llamado single step GBLUP o ssGBLUP).
