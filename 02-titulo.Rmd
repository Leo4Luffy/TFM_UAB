...
data.frame(
  ...
  annotate(geom = 'rect', xmin = 4.1, xmax = 6.3, ymin = 0.0, ymax = 2.2, colour = 'yellow', fill = 'yellow', alpha = 0.2) +
  annotate(geom = 'rect', xmin = 4.8, xmax = 6.2, ymin = 0.1, ymax = 1.5, colour = 'black', fill = 'black', alpha = 0.6) +
  annotate(geom = 'text', x = 4.5, y = 1.7, label = 'H', size = 6.4, colour = 'black') +
