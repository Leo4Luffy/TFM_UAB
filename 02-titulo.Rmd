...
data.frame(
  ...
  annotate(geom = 'text', x = 7.6, y = 1.1, label = 'ssGBLUP', size = 4.4, colour = 'black') +
  ...
  annotate(geom = 'text', x = 9.84, y = 1.575, label = '100122', size = 2.4, colour = 'black') +
  annotate(geom = 'text', x = 10.38, y = 0.975, label = '10012210120211', size = 2.4, colour = 'black') +
  annotate(geom = 'text', x = 10.90, y = 0.375, label = '1001221012021120012210', size = 2.4, colour = 'black') +
  
  scale_x_continuous(limits = c(2.5, 17.7)) +
  scale_y_continuous(limits = c(-1.0, 6.8)) +
  theme_bw() +
