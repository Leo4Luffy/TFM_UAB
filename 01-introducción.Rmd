...
pacman::p_load(dplyr, ggplot2, showtext, patchwork, latex2exp, gt, ggforce)
...
## Breve descripción de la mejora genética en arroz (*Oryza sativa L.*)

### La mejora genética en animales y plantas

Tras la domesticación de animales y el cultivo de plantas, la especie humana consiguió producir animales y plantas mejoradas. Esto a partir de la selección artificial. La clave del éxito de los antiguos domesticadores y cultivadores consistió en cruzar individuos portadores de caracteres deseables, al comprender que sus descendientes podrían heredar estas características, pese a que para esos tiempos se desconocían los mecanismos biológicos subyacentes a la herencia [@cite:43]. Hoy en día, al proceso de mejorar los caracteres fenotípicos deseables en animales y plantas mediante selección artificial, se le conoce como mejora genética [@cite:7], siendo la misma reconocida como una intrincada integración de ciencia y practicidad [@cite:42].
...
ggplot() +
  ...
  scale_x_continuous(limits = c(-0.25, 8.25)) +
...
data.frame(
  ...
  annotate(geom = 'text', x = 0.75, y = 11.5, label = 'Año', family = 'gochi', size = 3.2, colour = 'black') +
  annotate(geom = 'text', x = 0.75, y = 10.5, label = '1', family = 'gochi', size = 3.8, colour = 'black') +
  annotate(geom = 'text', x = 0.75, y = 9.5, label = '2', family = 'gochi', size = 3.8, colour = 'black') +
  annotate(geom = 'text', x = 0.75, y = 8.5, label = '3', family = 'gochi', size = 3.8, colour = 'black') +
  annotate(geom = 'text', x = 0.75, y = 7.5, label = '4', family = 'gochi', size = 3.8, colour = 'black') +
  annotate(geom = 'text', x = 0.75, y = 6.5, label = '5', family = 'gochi', size = 3.8, colour = 'black') +
  annotate(geom = 'text', x = 0.75, y = 5.5, label = '6', family = 'gochi', size = 3.8, colour = 'black') +
  annotate(geom = 'text', x = 0.75, y = 4.5, label = '7', family = 'gochi', size = 3.8, colour = 'black') +
  annotate(geom = 'text', x = 0.75, y = 3.5, label = '8', family = 'gochi', size = 3.8, colour = 'black') +
  annotate(geom = 'text', x = 0.75, y = 2.5, label = '9', family = 'gochi', size = 3.8, colour = 'black') +
  annotate(geom = 'text', x = 0.75, y = 1.5, label = '0', family = 'gochi', size = 3.8, colour = 'black') +
  
  annotate(geom = 'text', x = 2.75, y = 11.5, label = 'Generación', family = 'gochi', size = 3.2, colour = 'black') +
  annotate(geom = 'text', x = 2.75, y = 9.5, label = 'f1', family = 'gochi', size = 3.8, colour = 'black') +
  annotate(geom = 'text', x = 2.75, y = 8.5, label = 'f2', family = 'gochi', size = 3.8, colour = 'black') +
  annotate(geom = 'text', x = 2.75, y = 7.5, label = 'f3', family = 'gochi', size = 3.8, colour = 'black') +
  annotate(geom = 'text', x = 2.75, y = 6.5, label = 'f4', family = 'gochi', size = 3.8, colour = 'black') +
  annotate(geom = 'text', x = 2.75, y = 5.5, label = 'f5', family = 'gochi', size = 3.8, colour = 'black') +
  annotate(geom = 'text', x = 2.75, y = 4.5, label = 'f6', family = 'gochi', size = 3.8, colour = 'black') +
  annotate(geom = 'text', x = 2.75, y = 3.5, label = 'f7', family = 'gochi', size = 3.8, colour = 'black') +
  annotate(geom = 'text', x = 2.75, y = 2.5, label = 'f8', family = 'gochi', size = 3.8, colour = 'black') +
  annotate(geom = 'text', x = 2.75, y = 1.5, label = 'f9', family = 'gochi', size = 3.8, colour = 'black') +
  
  annotate(geom = 'text', x = 5.75, y = 10.5, label = 'P1 x P2', size = 3.4, colour = 'black') +
  ...
  geom_curve(x = 9.0, xend = 6.5, y = 10.5, yend = 10.5, arrow = arrow(length = unit(0.05, 'inch')), linetype = 'dashed', size = 0.1, color = 'black', curvature = 0.0) +
  geom_curve(x = 8.15, xend = 9.0, y = 1.5, yend = 1.5, arrow = arrow(length = unit(0.05, 'inch')), linetype = 'dashed', size = 0.1, color = 'black', curvature = 0.0) +
  geom_curve(x = 8.15, xend = 9.0, y = 3.5, yend = 3.5, arrow = arrow(length = unit(0.05, 'inch')), linetype = 'dashed', size = 0.1, color = 'black', curvature = 0.0) +
  ...
  scale_x_continuous(limits = c(0.0, 10.25)) +
