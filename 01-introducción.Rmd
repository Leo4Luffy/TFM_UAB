...
data.frame(
  ...
  annotate(geom = 'text', x = 4.5, y = 3.35, label = 'Planta/a-', size = 4.4, colour = 'black') +
  annotate(geom = 'text', x = 4.5, y = 3.05, label = 'nimal C', size = 4.4, colour = 'black') +
  ...
  annotate(geom = 'text', x = 3.25, y = 3.85, label = 'Planta/a-', size = 4.4, colour = 'black') +
  annotate(geom = 'text', x = 3.25, y = 3.55, label = 'nimal B', size = 4.4, colour = 'black') +
  ...
  annotate(geom = 'text', x = 2.0, y = 3.1, label = 'Planta/a-', size = 4.4, colour = 'black') +
  annotate(geom = 'text', x = 2.0, y = 2.8, label = 'nimal A', size = 4.4, colour = 'black') +
