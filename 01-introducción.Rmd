...
pacman::p_load(dplyr, ggplot2, showtext, patchwork)
...
Tanto en animales como en plantas, el interés principal en el mapeo de QTL consistió en usarse en un método conocido como selección asistida por marcadores (MAS) [@cite:3], proceso en el cual los individuos portadores de un marcador de ADN deseado podían ser identificados y utilizados para aumentar la respuesta genética de caracteres cuantitativos de relevancia económica [@cite:32]<!-- NOTA: la MAS se define como un tipo de selección indirecta basada en la asociación significativa entre un marcador de ADN y la variación de un caracter. -->. @cite:3 describen la MAS como un proceso en el cual se detectan los genes que afectan directamente un carácter (QTL), que al ser seleccionados, logran una mejora genética al aumentar la frecuencia del alelo favorable (Figura 1.2).
...
El uso de decenas de miles de marcadores de ADN es una de las características fundamentales de la selección genómica [@cite:10]. Al contar con tal cantidad de marcadores, se garantiza que algunos de ellos estén asociados (o en desequilibrio de ligamiento) con el QTL [@cite:8], con lo cual dicho marcador representa al QTL aún cuando el mismo no tiene efecto biológico sobre el carácter [@cite:30; @cite:35].
...
data.frame(
  ...
  annotate(geom = 'rect', xmin = 3.5, xmax = 6.5, ymin = 8.0, ymax = 9.0, colour = 'black', fill = 'black', alpha = 0.2) +
  ...
  annotate(geom = 'rect', xmin = 0.15, xmax = 4.85, ymin = 6.4, ymax = 7.0, colour = 'black', fill = 'black', alpha = 0.2) +
  annotate(geom = 'text', x = 2.5, y = 6.7, label = 'Enfoque penalizado', size = 3.4, colour = 'black') +
  ...
  annotate(geom = 'text', x = 7.5, y = 6.7, label = 'Enfoque bayesiano', size = 3.4, colour = 'black') +
  
  annotate(geom = 'segment', x = 1.25, xend = 1.25, y = 6.4, yend = 5.7, colour = 'black') +
  geom_curve(x = 1.25, xend = 1.75, y = 5.7, yend = 5.7, arrow = arrow(length = unit(0.1, 'inch')), size = 0.2, color = 'black', curvature = 0.0, linetype = 'solid') +
  annotate(geom = 'text', x = 2.8, y = 5.7, label = 'GBLUP', size = 3.4, colour = 'black') +
...
::: {.center data-latex=""}
__Figura 1.4:__ . Figura adaptada de @cite:31.
:::
...
Punto_1 <- data.frame(x = c(0.5, 0.5, 0.5), y = c(8.0, 5.5, 3.0))
Punto_2 <- data.frame(x = c(3.0, 3.0, 3.0, 3.0), y = c(9.25, 6.75, 4.25, 1.75))
...
data.frame(
  ...
  geom_point(aes(x = x, y = y), data = Punto_1, size = 11.6, shape = 21, color = 'cyan', fill = 'cyan', alpha = 0.4) +
  geom_point(aes(x = x, y = y), data = Punto_2, size = 11.6, shape = 21, color = 'red', fill = 'red', alpha = 0.4) +
  geom_point(aes(x = x, y = y), data = Punto_3, size = 11.6, shape = 21, color = 'black', fill = 'black', alpha = 0.4) +
  
  geom_curve(x = -0.5, xend = 0.0, y = 8.0, yend = 8.0, arrow = arrow(length = unit(0.1, 'inch')), size = 0.8, color = 'black', curvature = 0.0, linetype = 'twodash') +
  annotate(geom = 'text', x = -0.8, y = 8.0, label = 'SNP 1', family = 'gochi', size = 3.5, colour = 'black', angle = 90) +
  ...
  annotate(geom = 'text', x = -0.8, y = 5.5, label = 'SNP 2', family = 'gochi', size = 3.5, colour = 'black', angle = 90) +
  
  geom_curve(x = -0.5, xend = 0.0, y = 3.0, yend = 3.0, arrow = arrow(length = unit(0.1, 'inch')), size = 0.8, color = 'black', curvature = 0.0, linetype = 'twodash') +
  annotate(geom = 'text', x = -0.8, y = 3.0, label = 'SNP 3', family = 'gochi', size = 3.5, colour = 'black', angle = 90) +
  ...
  annotate(geom = 'text', x = 3.0, y = 0.15, label = 'Oculta', size = 3.8, colour = 'black') +
  annotate(geom = 'text', x = 5.5, y = 3.9, label = 'Salida', size = 3.8, colour = 'black') +
  
  geom_curve(x = 0.8, xend = 2.7, y = 8.0, yend = 9.25, arrow = arrow(length = unit(0.1, 'inch')), size = 0.4, color = 'black', curvature = 0.0) +
  geom_curve(x = 0.8, xend = 2.7, y = 8.0, yend = 6.75, arrow = arrow(length = unit(0.1, 'inch')), size = 0.4, color = 'black', curvature = 0.0) +
  geom_curve(x = 0.8, xend = 2.7, y = 8.0, yend = 4.25, arrow = arrow(length = unit(0.1, 'inch')), size = 0.4, color = 'black', curvature = 0.0) +
  geom_curve(x = 0.8, xend = 2.7, y = 8.0, yend = 1.25, arrow = arrow(length = unit(0.1, 'inch')), size = 0.4, color = 'black', curvature = 0.0) +
  
  geom_curve(x = 0.8, xend = 2.7, y = 5.5, yend = 9.25, arrow = arrow(length = unit(0.1, 'inch')), size = 0.4, color = 'black', curvature = 0.0) +
  geom_curve(x = 0.8, xend = 2.7, y = 5.5, yend = 6.75, arrow = arrow(length = unit(0.1, 'inch')), size = 0.4, color = 'black', curvature = 0.0) +
  geom_curve(x = 0.8, xend = 2.7, y = 5.5, yend = 4.25, arrow = arrow(length = unit(0.1, 'inch')), size = 0.4, color = 'black', curvature = 0.0) +
  geom_curve(x = 0.8, xend = 2.7, y = 5.5, yend = 1.25, arrow = arrow(length = unit(0.1, 'inch')), size = 0.4, color = 'black', curvature = 0.0) +
  
  geom_curve(x = 0.8, xend = 2.7, y = 3.0, yend = 9.25, arrow = arrow(length = unit(0.1, 'inch')), size = 0.4, color = 'black', curvature = 0.0) +
  geom_curve(x = 0.8, xend = 2.7, y = 3.0, yend = 6.75, arrow = arrow(length = unit(0.1, 'inch')), size = 0.4, color = 'black', curvature = 0.0) +
  geom_curve(x = 0.8, xend = 2.7, y = 3.0, yend = 4.25, arrow = arrow(length = unit(0.1, 'inch')), size = 0.4, color = 'black', curvature = 0.0) +
  geom_curve(x = 0.8, xend = 2.7, y = 3.0, yend = 1.25, arrow = arrow(length = unit(0.1, 'inch')), size = 0.4, color = 'black', curvature = 0.0) +
  
  geom_curve(x = 3.3, xend = 5.2, y = 9.25, yend = 5.5, arrow = arrow(length = unit(0.1, 'inch')), size = 0.4, color = 'black', curvature = 0.0) +
  geom_curve(x = 3.3, xend = 5.2, y = 6.75, yend = 5.5, arrow = arrow(length = unit(0.1, 'inch')), size = 0.4, color = 'black', curvature = 0.0) +
  geom_curve(x = 3.3, xend = 5.2, y = 4.25, yend = 5.5, arrow = arrow(length = unit(0.1, 'inch')), size = 0.4, color = 'black', curvature = 0.0) +
  geom_curve(x = 3.3, xend = 5.2, y = 1.25, yend = 5.5, arrow = arrow(length = unit(0.1, 'inch')), size = 0.4, color = 'black', curvature = 0.0) +
  
  scale_x_continuous(limits = c(-1.65, 7.55)) +
  scale_y_continuous(limits = c(-1.0, 11.0)) +
...
::: {.center data-latex=""}
__Figura 1.5:__ . Figura adaptada de @cite:7.
:::