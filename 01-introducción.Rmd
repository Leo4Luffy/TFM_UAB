...
data.frame(
  ...
  geom_curve(x = 7.1, xend = 8.6, y = 2.825, yend = 2.825, arrow = arrow(length = unit(0.05, 'inch')), size = 0.5, color = 'black', curvature = 0.0, linetype = 'dashed') +
...
(ablup / gblup) | (ssgblup) #-> Mej_anim_plant
