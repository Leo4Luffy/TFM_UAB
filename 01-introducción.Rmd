...
Siguiendo la misma línea de @cite:8, @cite:39 propuso un método donde la predicción se obtiene en base a relaciones genómicas (esto es, la proporción de alelos compartidos entre individuos) en lugar de la relación de parentesco basado en pedigríes. A esta se le denomino como el mejor predictor lineal insesgado genómico (GBLUP).
...
data.frame(x = c(3.7, 4.3, 4.0, 3.4, 4.6), y = c(1.5, 1.5, 0.9, 0.9, 0.9)) %>%
  ...
  annotate(geom = 'text', x = 4.3, y = 1.6, label = 'A3', family = 'gochi', size = 3.2, colour = 'black') +
  annotate(geom = 'text', x = 4.3, y = 1.4, label = 'A4', family = 'gochi', size = 3.2, colour = 'black') +
  ...
  annotate(geom = 'text', x = 4.0, y = 0.8, label = 'A3', family = 'gochi', size = 3.2, colour = 'black') +
  ...
  annotate(geom = 'text', x = 3.4, y = 0.8, label = 'A3', family = 'gochi', size = 3.2, colour = 'black') +
  ...
  annotate(geom = 'text', x = 4.6, y = 0.8, label = 'A4', family = 'gochi', size = 3.2, colour = 'black') +
  ...
  annotate(geom = 'text', x = 3.65, y = 0.45, label = TeX('$f_{m} = 0.5$'), size = 4.2) +
  
  annotate(geom = 'rect', xmin = 4.05, xmax = 4.65, ymin = 0.4, ymax = 0.5, colour = 'black', fill = 'white', size = 0.2, linetype = 'solid') +
  annotate(geom = 'text', x = 4.35, y = 0.45, label = TeX('$f_{m} = 0.0$'), size = 4.2) +
