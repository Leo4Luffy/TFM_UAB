...
\begin{align*}
y = Z \left[ \frac{g_{1}}{g_{2}} \right] + e,
\end{align*}
...
\begin{align*}
a_{1} = cov(a_{1}, a_{2}) \times \left[ var(a_{2} \right]^{-1} \times a_{2} + e
\end{align*}
...
\begin{align*}
a_{1} = A_{12} \times A_{22}^{-1} \times a_{2} + e
\end{align*}

Luego la expresión anterior en términos de varianza:

\begin{align*}
var(a_{1}) = var(A_{12} \times A_{22}^{-1} \times a_{2}) + var(e)
\end{align*}

Con un poco de algebra, la expresión anterior pasa a ser:

\begin{align*}
var(a_{1}) = A_{11} + A_{12} \times A_{22}^{-1} \times G - A_{22} \times A_{22}^{-1} \times A_{21}
\end{align*}
