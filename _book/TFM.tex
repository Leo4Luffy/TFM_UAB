...
La historia de la genética tanto cuantitativa como molecular se remonta a la contribución de muchas personas (Figura \ldots{}), hecho que permitió la conexión entre ambas disciplinas y el desarrollo de lo que hoy en día se conoce como selección genómica.
...
\begin{center}\includegraphics[width=1\linewidth]{TFM_files/figure-latex/unnamed-chunk-23-1} \end{center}

\begin{center}\includegraphics[width=1\linewidth]{TFM_files/figure-latex/unnamed-chunk-23-2} \end{center}

\begin{center}\includegraphics[width=1\linewidth]{TFM_files/figure-latex/unnamed-chunk-23-3} \end{center}
...
\begin{center}\includegraphics[width=1\linewidth]{TFM_files/figure-latex/unnamed-chunk-24-1} \end{center}

\begin{center}\includegraphics[width=1\linewidth]{TFM_files/figure-latex/unnamed-chunk-24-2} \end{center}

\begin{center}\includegraphics[width=1\linewidth]{TFM_files/figure-latex/unnamed-chunk-24-3} \end{center}
...
\begin{center}\includegraphics[width=1\linewidth]{TFM_files/figure-latex/unnamed-chunk-25-2} \end{center}

\begin{center}\includegraphics[width=1\linewidth]{TFM_files/figure-latex/unnamed-chunk-25-3} \end{center}
...
\begin{center}\includegraphics[width=1\linewidth]{TFM_files/figure-latex/unnamed-chunk-26-1} \end{center}

\begin{center}\includegraphics[width=1\linewidth]{TFM_files/figure-latex/unnamed-chunk-26-2} \end{center}

\begin{center}\includegraphics[width=1\linewidth]{TFM_files/figure-latex/unnamed-chunk-26-3} \end{center}
...
\begin{center}\includegraphics[width=1\linewidth]{TFM_files/figure-latex/unnamed-chunk-27-2} \end{center}

\begin{center}\includegraphics[width=1\linewidth]{TFM_files/figure-latex/unnamed-chunk-27-3} \end{center}
