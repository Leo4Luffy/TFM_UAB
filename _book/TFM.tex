...
\hypertarget{breve-descripciuxf3n-de-la-mejora-genuxe9tica-en-arroz-oryza-sativa-l.}{%
\section{\texorpdfstring{Breve descripción de la mejora genética en arroz (\emph{Oryza sativa L.})}{Breve descripción de la mejora genética en arroz (Oryza sativa L.)}}\label{breve-descripciuxf3n-de-la-mejora-genuxe9tica-en-arroz-oryza-sativa-l.}}

\hypertarget{la-mejora-genuxe9tica-en-animales-y-en-plantas}{%
\subsection{La mejora genética en animales y en plantas}\label{la-mejora-genuxe9tica-en-animales-y-en-plantas}}
...
Por otro lado, desde el momento en que la selección genómica fue propuesta por Meuwissen, Hayes, y Goddard (\protect\hyperlink{ref-cite:8}{2001}), se adapto rápidamente a la mejora genética de animales, principalmente al sector ganadero. Sin embargo, el uso de la selección genómica en plantas ha sido lento y son varias las razones de ello (Hickey et~al. \protect\hyperlink{ref-cite:44}{2017}):

1- Los métodos en la mejora genética de animales y plantas han divergido un poco, lo cual implica que se requiera de tiempo para que los avances y las contribuciones realizadas en un campo se trasladen al otro.

2- La complejidad de los genomas de muchas especies de plantas. Los animales al ser individuos diploides, aportan a su descendencia solo uno de los dos alelos de cada gen, por lo cual es más fácil predecir en ellos cuan efectiva sera la selección al suponer que de los diferentes componentes de la variación genética, solo la variación aditiva es la heredable (denominado esto como heredabilidad en el sentido estricto). Caso contrario a las plantas cuya respuesta a la selección puede implicar la interacción de dominancia entre dos alelos, en caso de que la especie sea poliploide o se haya propagado de forma vegetativa (Holland \protect\hyperlink{ref-cite:43}{2014}).

3- Varios mejoradores genéticos de plantas argumentan que se pueden obtener algunos de los beneficios esperados de la selección genómica a través del uso de otras tecnologías y métodos.

4- El gasto de invertir en infraestructura computacional y de registro tanto en los datos genotípicos como fenotípicos requeridos para implementar efectivamente la selección genómica.

A pesar de las diferencias en la mejora genética de animales y plantas, ambas disciplinas requieren conceptos y herramientas similares para la predicción genómica. Por lo tanto, es de esperar que los mejoradores genéticos de animales y de plantas se beneficien del trabajo conjunto para solucionar aquellos problemas que son comunes.
...
\begin{center}\includegraphics[width=1\linewidth]{TFM_files/figure-latex/unnamed-chunk-21-1} \end{center}
...
\begin{center}\includegraphics[width=1\linewidth]{TFM_files/figure-latex/unnamed-chunk-22-1} \end{center}

\begin{center}\includegraphics[width=1\linewidth]{TFM_files/figure-latex/unnamed-chunk-22-2} \end{center}

\begin{center}\includegraphics[width=1\linewidth]{TFM_files/figure-latex/unnamed-chunk-22-3} \end{center}
