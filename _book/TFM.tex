...
Se observaron valores altos de heredabilidad (mayores a 0.58), con densidades de marcadores variadas en 451 individuos genotipados (Figura 5.3), lo que indica que el tiempo de floración es un carácter muy heredable. Ambos enfoques (Bayesianos y REML), proporcionaron estimaciones de heredabilidad muy similares. Se pudo observar también que las varianzas genéticas aditivas obtenidas en los modelos de selección genómica (ssGBLUP) fueron más bajas comparadas con las obtenidas a partir del BLUP (esto es, con una densidad de marcador igual a 0). A este respecto, los métodos de selección genómica basados en información de genotipos (como es el caso del ssGBLUP) pueden revelar relaciones entre individuos que aparentemente no están relacionados en el pedigrí (Pszczola et~al. \protect\hyperlink{ref-cite:74}{2012}), hecho que puede resultar en una sobreestimación de la varianza genética aditiva en el BLUP (Ratcliffe et~al. \protect\hyperlink{ref-cite:72}{2017}).
