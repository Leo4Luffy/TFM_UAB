...
\begin{center}
\textbf{Figura 5.2:} Precisión de la predicción con tamaños crecientes en el número de marcadores y de individuos genotipados. Los tres pedigríes (Pedigrí 1-2-3) corresponden a los pedigríes generados en simulaciones hacia atras.

\end{center}

\hypertarget{efecto-de-la-densidad-del-marcador-y-de-la-cantidad-de-individuos-genotipados-en-la-precisiuxf3n-de-la-predicciuxf3n-mediante-simulaciones-hacia-adelante}{%
\section{Efecto de la densidad del marcador y de la cantidad de individuos genotipados en la precisión de la predicción mediante simulaciones hacia adelante}\label{efecto-de-la-densidad-del-marcador-y-de-la-cantidad-de-individuos-genotipados-en-la-precisiuxf3n-de-la-predicciuxf3n-mediante-simulaciones-hacia-adelante}}
