...
Siguiendo la misma línea de Meuwissen, Hayes, y Goddard (\protect\hyperlink{ref-cite:8}{2001}), VanRaden (\protect\hyperlink{ref-cite:39}{2007}) propuso un método donde la predicción se obtiene en base a relaciones genómicas (esto es, la proporción de alelos compartidos entre individuos) en lugar de la relación de parentesco basados en pedigríes. A esta se le denomino como el mejor predictor lineal insesgado genómico (GBLUP).
