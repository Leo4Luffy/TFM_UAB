...
\hypertarget{la-mejora-genuxe9tica-en-animales-y-plantas}{%
\subsection{La mejora genética en animales y plantas}\label{la-mejora-genuxe9tica-en-animales-y-plantas}}

Tras la domesticación de animales y el cultivo de plantas, la especie humana consiguió producir animales y plantas mejoradas. Esto a partir de la selección artificial. La clave del éxito de los antiguos domesticadores y cultivadores consistió en cruzar individuos portadores de caracteres deseables, al comprender que sus descendientes podrían heredar estas características, pese a que para esos tiempos se desconocían los mecanismos biológicos subyacentes a la herencia (Holland \protect\hyperlink{ref-cite:43}{2014}). Hoy en día, se conoce como mejora genética al proceso de mejorar los caracteres fenotípicos deseables en animales y plantas mediante selección artificial (Tong y Nikoloski \protect\hyperlink{ref-cite:7}{2021}), siendo la misma reconocida como una intrincada integración de ciencia y practicidad (Caligari y Brown \protect\hyperlink{ref-cite:42}{2017}).

A pesar de las similitudes conceptuales en la mejora genética de animales y plantas, los métodos de mejora históricamente usados han divergido. En plantas, los mejoradores genéticos han utilizado principalmente la MAS con el fin de identificar e incorporar genes beneficiosos. Por lo tanto, aquellos genes (generalmente pocos) con efectos moderados a grandes se han explotado más ampliamente en plantas que en animales. Por otra parte, en animales la mayoría de caracteres económicamente importantes son cuantitativos y complejos, hecho que obligo a los mejoradores genéticos a utilizar enfoques biométricos para determinar el EBV mediante la combinación de información fenotípica y de pedigrí (propiamente el BLUP), y con ello tomar las decisiones de selección (Hickey et~al. \protect\hyperlink{ref-cite:44}{2017}). En este último aspecto, Nakaya y Isobe (\protect\hyperlink{ref-cite:6}{2012}) y Tong y Nikoloski (\protect\hyperlink{ref-cite:7}{2021}) señalan que el BLUP no es factible para poblaciones sin información de pedigrí o con una estructura poblacional compleja, como suele ser el caso de las plantas.

\begin{center}\includegraphics[width=1\linewidth]{figures/Mej_Anim_Plan} \end{center}

\begin{center}
\textbf{Figura 1.8:} Enfoques de mejora genética en animales y plantas. Figura adaptada de Hickey et~al. (\protect\hyperlink{ref-cite:44}{2017}).
