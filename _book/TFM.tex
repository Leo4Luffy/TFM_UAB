...
Al representar las diferencias en el ADN heredado por dos individuos (Legarra et~al. \protect\hyperlink{ref-cite:15}{2014}), mediante el uso de marcadores de ADN se abrió la posibilidad de obtener una predicción más precisa de los EBV (Misztal, Aggrrey, y Muir \protect\hyperlink{ref-cite:14}{2012}; Campos et~al. \protect\hyperlink{ref-cite:31}{2013}), comparado al método BLUP mencionado en párrafos anteriores. Según los mismos autores (Campos et~al. \protect\hyperlink{ref-cite:31}{2013}), los primeros intentos de integrar datos de marcadores de ADN en las predicciones se basaron en el supuesto de que era posible encontrar genes que contribuyeran a la variación genética del carácter. Este enfoque, conocido como etiquetado de genes o mapeo de QTL , permitió el descubrimiento de genes asociados a diferencias genéticas entre individuos dado un fenotipo (Campos et~al. \protect\hyperlink{ref-cite:31}{2013}; Legarra, Lourenco, y Vitezica \protect\hyperlink{ref-cite:30}{2018}).

Tanto en animales como en plantas, el interés principal en el mapeo de QTL consistió en un método conocido como selección asistida por marcadores (MAS) (Blasco y Toro \protect\hyperlink{ref-cite:3}{2014}), proceso en el cual los individuos portadores de un marcador de ADN deseado podían ser identificados y utilizados para aumentar la respuesta genética de caracteres cuantitativos importantes en la agricultura (Kyselova, Tichý, y Jochová \protect\hyperlink{ref-cite:32}{2021}). Blasco y Toro (\protect\hyperlink{ref-cite:3}{2014}) describen la MAS (Figura 1.2) como un proceso de tres pasos, en el cual se detecta uno o varios QTL que posteriormente permiten encontrar el gen responsable de la variación genética que más adelante al ser seleccionado aumenta la frecuencia del alelo favorable.

\begin{center}\includegraphics[width=1\linewidth]{TFM_files/figure-latex/unnamed-chunk-46-1} \end{center}
...
\begin{center}
\textbf{Figura 1.3:} Principio de la selección genómica. La selección genómica utiliza un modelo estadístico, diseñado a partir de datos genotípicos y fenotípicos en una población de entrenamiento, para predecir el fenotipo de los individuos en una población de prueba con datos genotípicos. Por último, los fenotipos predichos se usan en la selección. Figura adaptada de Tong y Nikoloski (\protect\hyperlink{ref-cite:7}{2021}).
...
\begin{center}\includegraphics[width=1\linewidth]{TFM_files/figure-latex/unnamed-chunk-49-1} \end{center}
...
\begin{center}\includegraphics[width=1\linewidth]{TFM_files/figure-latex/unnamed-chunk-50-1} \end{center}
...
\begin{center}\includegraphics[width=1\linewidth]{TFM_files/figure-latex/unnamed-chunk-51-1} \end{center}
...
\begin{center}\includegraphics[width=1\linewidth]{TFM_files/figure-latex/unnamed-chunk-55-1} \end{center}
...
\begin{center}\includegraphics[width=1\linewidth]{TFM_files/figure-latex/unnamed-chunk-56-1} \end{center}

\begin{center}\includegraphics[width=1\linewidth]{TFM_files/figure-latex/unnamed-chunk-56-2} \end{center}

\begin{center}\includegraphics[width=1\linewidth]{TFM_files/figure-latex/unnamed-chunk-56-3} \end{center}
...
Campos, G. de los, J. H. Hickey, R. Pong-Wong, H. D. Daetwyler, y M. P. L. Calus. 2013. «Whole-genome regression and prediction methods applied to plant and animal breeding». \emph{Genetics} 193: 327-45. \url{https://doi.org/10.1534/genetics.112.143313}.
