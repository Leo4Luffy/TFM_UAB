...
\section{Fenotipo y heredabilidad}\label{fenotipo-y-heredabilidad}}
...
\begin{center}
\textbf{Figura 5.1:} Distribuciones posteriores de componentes de varianza y de heredabilidad obtenidas mediante enfoques Bayesianos. Los valores presentados en la Tabla 5.1 (para el enfoque Bayesiano), corresponden a la media calculada a partir de estas distribuciones.

\end{center}

\hypertarget{comparaciuxf3n-de-la-precisiuxf3n-de-la-predicciuxf3n-en-pedigruxedes-generados-mediante-simulaciones-hacia-atruxe1s}{%
\section{Comparación de la precisión de la predicción en pedigríes generados mediante simulaciones hacia atrás}\label{comparaciuxf3n-de-la-precisiuxf3n-de-la-predicciuxf3n-en-pedigruxedes-generados-mediante-simulaciones-hacia-atruxe1s}}

Usando datos con distintas densidades de SNP e información de pedigrí, se construyeron matrices H que fueron usadas en el ssGBLUP para evaluar la precisión de la predicción en individuos genotipados para el caracter tiempo de floración. Para la construcción de estas matrices, además de la densidad de SNP, se consideraron también distinta cantidad de individuos genotipados. Para el caso de ningún individuo genotipado, la precisión de la predicción se evaluó usando las relaciones genéticas esperadas definidas en la matriz A mediante BLUP. En relación con esto, la precisión de la predicción para los distintos casos considerados, con los tres pedigríes simulados (hacia atrás), se muestran en la Figura 5.2 y en el Anexo A.3.
...
\begin{center}\includegraphics[width=1\linewidth]{TFM_files/figure-latex/unnamed-chunk-29-1} \end{center}
...
\hypertarget{comparaciuxf3n-de-la-precisiuxf3n-de-la-predicciuxf3n-en-pedigruxedes-generados-mediante-simulaciones-hacia-adelante}{%
\section{Comparación de la precisión de la predicción en pedigríes generados mediante simulaciones hacia adelante}\label{comparaciuxf3n-de-la-precisiuxf3n-de-la-predicciuxf3n-en-pedigruxedes-generados-mediante-simulaciones-hacia-adelante}}
...
\begin{center}\includegraphics[width=1\linewidth]{TFM_files/figure-latex/unnamed-chunk-31-1} \end{center}
