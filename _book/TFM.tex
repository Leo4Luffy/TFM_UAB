...
Se usaron diferentes matrices H basados en diferentes matrices G, situación que se describe en las dos metodologías que se describen a continuación. En el anexo A.1 se presenta la función \texttt{R} usada para construir la matriz H.

\hypertarget{habilidad-predictiva-subconjuntos-de-datos-y-simulaciuxf3n-de-pedigruxedes-ancestrales}{%
\section{Habilidad predictiva, subconjuntos de datos y simulación de pedigríes ancestrales}\label{habilidad-predictiva-subconjuntos-de-datos-y-simulaciuxf3n-de-pedigruxedes-ancestrales}}
