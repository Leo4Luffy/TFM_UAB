...
Al publicar su propuesta innovadora de selección genómica, Meuwissen, Hayes, y Goddard (\protect\hyperlink{ref-cite:8}{2001}) dieron a conocer también la forma en como la misma podía resolverse. La idea consistió en representar la relación entre el fenotipo y el genotipo mediante un modelo de regresión lineal (Figura 1.4), que luego podía usarse para predecir el GEBV de los individuos (Nakaya y Isobe \protect\hyperlink{ref-cite:6}{2012}; delosCampos et~al. \protect\hyperlink{ref-cite:31}{2013}).

\begin{center}\includegraphics[width=1\linewidth]{figures/Mod_RL} \end{center}

\begin{center}
\textbf{Figura 1.4:} . Figura adaptada de Nakaya y Isobe (\protect\hyperlink{ref-cite:6}{2012}).
...
\begin{center}
\textbf{Figura 1.5:} . Figura adaptada de delosCampos et~al. (\protect\hyperlink{ref-cite:31}{2013}).
