...
Los conjuntos de datos genotípicos y fenotípicos usados en este estudio se obtuvieron del \href{https://snp-seek.irri.org/index.zul;jsessionid=DD991975FDC4F320BE3C33ED056D0363}{Rice SNP-Seek Database}, el cual es un cibersitio donde se proporciona información sobre datos de genotipos y de fenotipos de distintas variedades de arroz (\emph{Oryza sativa L.}).

En relación a los datos de genotipo,

\begin{center}\includegraphics[width=1\linewidth]{TFM_files/figure-latex/unnamed-chunk-2-1} \end{center}

\begin{center}
\textbf{Figura 2.1:} Estructura poblacional de datos de arroz. A saber, los puntos y las circuferencias de color representan los distintos grupos varietales de arroz: tipo intermedio o mezclado (ADM), aromático (ARO), aus (AUS), indica (IND) y japónica (JAP).

\end{center}

En relación a los datos de fenotipo, en el conjunto de datos se proporcionaba información sobre distintos caracteres fenotípicos de relevancia agronómica como son la trillabilidad de la panícula, el peso del grano, la fuerza del culmo, entre otros (Fig. 2.2), siendo seleccionada para este estudio el carácter tiempo de floración ya que este mostró suficiente variación fenotípica.
...
\hypertarget{modelo-para-la-predicciuxf3n-genuxf3mica}{%
\subsection{Modelo para la predicción genómica}\label{modelo-para-la-predicciuxf3n-genuxf3mica}}

\hypertarget{precisiuxf3n-de-la-predicciuxf3n-genuxf3mica-mediante-validaciuxf3n-cruzada}{%
\subsection{Precisión de la predicción genómica mediante validación cruzada}\label{precisiuxf3n-de-la-predicciuxf3n-genuxf3mica-mediante-validaciuxf3n-cruzada}}
