...
## Delimiter: "\t"
## dbl (10): value...1, value...2, value...3, value...4, value...5,...
\end{verbatim}
...
\begin{verbatim}
## Warning in is.na(x): is.na() aplicado a un objeto que no es (lista o
## vector) de tipo 'expression
