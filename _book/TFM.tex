...
\hypertarget{fenotipo-y-heredabilidades}{%
\subsection{Fenotipo y heredabilidades}\label{fenotipo-y-heredabilidades}}
...
\begin{center}\includegraphics[width=1\linewidth]{TFM_files/figure-latex/unnamed-chunk-6-2} \end{center}

\begin{center}\includegraphics[width=1\linewidth]{TFM_files/figure-latex/unnamed-chunk-6-3} \end{center}
