...
\begin{center}
\textbf{Tabla 5.1:} Estimaciones de heredabilidad para el caracter tiempo de floración mediante el método BLUP.
...
\midrule
Heredabilidad & 0.72 & 0.78 & 0.84 & 0.8 & 0.79 & 0.84 \\ 
 \bottomrule
\end{longtable}
\vspace{-5mm}
\begin{minipage}{\linewidth}
...
\begin{center}\includegraphics[width=1\linewidth]{figures/covar_h2_2} \end{center}

\begin{center}
\textbf{Figura 5.1:} Distribuciones posteriores de heredabilidad obtenidas mediante enfoques Bayesianos. Los valores presentados en la Tabla 5.1 (para el enfoque Bayesiano), corresponden a la media calculada a partir de estas distribuciones.
...
A pesar del interés que en su momento hubo en el uso de la información de pedigrí para la mejora genética de animales, el uso de esta información en plantas no fue relevante (Robertsen, Hjortshøj, y Janss \protect\hyperlink{ref-cite:63}{2019}). Con el desarrollo de la selección genómica y el éxito posterior alcanzado a través de su implementación en animales, se vio la posibilidad de usar esta metodología para la mejora de la ganancia genética en plantas (Nakaya y Isobe \protect\hyperlink{ref-cite:6}{2012}), y en tiempo más recientes se ha demostrado su uso en la mejora genética de los cultvos de arroz a través de estudios de simulación (Xu et~al. \protect\hyperlink{ref-cite:60}{2021}).
