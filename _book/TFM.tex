...
\tightlist
\item
  Uso de subconjuntos de datos con diferentes densidades de SNP:
\end{enumerate}
...
\section{\texorpdfstring{\href{http://rstudio-pubs-static.s3.amazonaws.com/378595_edda8cfe948a4786ae6dd74962cf6e94.html}{Función} para el calculo de la matriz de parentesco combinada}{Función para el calculo de la matriz de parentesco combinada}}\label{funciuxf3n-para-el-calculo-de-la-matriz-de-parentesco-combinada}}
