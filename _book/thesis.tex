...
\vspace{\baselineskip}
\Large\textit{MÁSTER INTERUNIVERSITARIO EN MEJORA GENÉTICA ANIMAL\\
\hspace*{0.333em}Y BIOTECNOLOGÍA DE LA REPRODUCCIÓN}\par
...
op Colocar aquí la fecha de la defensa, te […time…] uur \\ }\par %
\vspace{\baselineskip}
{\large door}\par
\vspace{\baselineskip}
{\Large Jorge Leonardo López Martínez}\par
\vspace{\baselineskip}
{\large geboren te Barcelona, España}
\end{center}
