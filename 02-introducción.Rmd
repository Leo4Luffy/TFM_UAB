...
Posterior al método de selección masal, se propuso un método en plantas en el cual la mejora genética era posible a través del apareamiento controlado de individuos. Esto a partir de  dos estrategias de apareamiento (Figura 2.10).
...
data.frame(
  ...
  geom_curve(x = 4.9, xend = 4.4, y = 8.0, yend = 7.4, arrow = arrow(length = unit(0.05, 'inch')), size = 0.1, color = 'black', curvature = 0.0) +
  ...
  annotate(geom = 'text', x = 3.65, y = 4.2, label = 'BCn-1', family = 'gochi', size = 3.4, colour = 'black') +
