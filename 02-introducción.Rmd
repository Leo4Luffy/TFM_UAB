...
::: {.center data-latex=""}
__Figura 1.9:__ Evolución de la producción y uso del arroz <!--(_Oryza sativa L._)--> a nivel mundial. Se utilizaron las bases de datos estadísticos de la Organización para la Alimentación y la Agricultura - [FAOSTAT](http://faostat.fao.org/) para desarrollar estas figuras.
:::
