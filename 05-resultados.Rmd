...
En relación a la precisión de la predicción debido a la densidad del marcador, esta fue mayor cuando se consideró una densidad de marcador igual a 0 en comparación a una densidad aproximada de 1.000 (en todos los casos de individuos genotipados). Al considerar una densidad del marcador aproximado de 10.000 y de 100.000, dicha precisión tendió a aumentar, mostrando la precisión de la predicción más alta cuando se usaron todos los marcadores disponibles (aunque en el caso en el que se consideró el genotipado de 148 individuos, la precisión de la predicción usando tal cantidad de marcadores no pudo superar el caso donde se consideró una densidad igual a 0). Sin embargo, dado el aumento marginal en la precisión de la predicción al aumentar de 10.000 a 100.000, es posible afirmar que el limite en el aumento de la precisión se alcanzó en aproximadamente 10.000 marcadores. Este comportamiento de la densidad del marcador sobre la precisión de la predicción curiosamente se observó por igual en los tres pedigríes generados a partir de las simulaciones hacia atrás, tanto en el enfoque Bayesianos y como en REML.
...
(mA_ped4_map_b | mA_ped4_map_a | mH_ped4c_map_b | mH_ped4c_map_a) / (mH_ped4b_map_b | mH_ped4b_map_a | mH_ped4a_map_b | mH_ped4a_map_a) -> map_dens
