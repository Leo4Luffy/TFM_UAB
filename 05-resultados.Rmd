...
param_gen %>%
  ...
  labs(title = ' ', subtitle = ' ', y = 'Heredabilidad', x = 'Densidad del marcador') +
  theme_bw() +
  theme(
...
param_gen %>%
  ...
  #geom_label(aes(label = round(prom, digits = 2)), colour = 'black', position = position_dodge(width = 1)) +
  scale_y_continuous(limits = c(0.0, 1.0)) +
  labs(title = ' ', y = 'Heredabilidad', x = 'Densidad del marcador') +
  theme_bw() +
  theme(
    axis.text.y = element_text(size = 10, face = 'bold'),
    axis.text.x = element_text(size = 7.4, face = 'bold'),
...
(varA_ind_gen_bay_ped1 | varE_ind_gen_bay_ped1 | Here_ind_gen_bay_ped1) / (varA_ind_gen_bay_ped2 | varE_ind_gen_bay_ped2 | Here_ind_gen_bay_ped2) / (varA_ind_gen_bay_ped3 | varE_ind_gen_bay_ped3 | Here_ind_gen_bay_ped3) -> param_Bayes
...
(varA_ind_gen_reml_ped1 | varE_ind_gen_reml_ped1 | Here_ind_gen_reml_ped1) / (varA_ind_gen_reml_ped2 | varE_ind_gen_reml_ped2 | Here_ind_gen_reml_ped2) / (varA_ind_gen_reml_ped3 | varE_ind_gen_reml_ped3 | Here_ind_gen_reml_ped3) -> param_reml
...
param_gen %>%
  ...
  #geom_label(aes(label = round(prom, digits = 2)), colour = 'black', position = position_dodge(width = 1)) +
  scale_y_continuous(limits = c(0.0, 1.0)) +
  labs(title = ' ', subtitle = ' ', y = 'Heredabilidad', x = 'Individuos genotipados') +
  theme_bw() +
  theme(
    axis.text.y = element_text(size = 10, face = 'bold'),
    axis.text.x = element_text(size = 7.4, face = 'bold'),
...
param_gen %>%
  ...
  #geom_label(aes(label = round(prom, digits = 2)), colour = 'black', position = position_dodge(width = 1)) +
  scale_y_continuous(limits = c(0.0, 1.0)) +
  labs(title = ' ', y = 'Heredabilidad', x = 'Individuos genotipados') +
  theme_bw() +
  theme(
    axis.text.y = element_text(size = 10, face = 'bold'),
    axis.text.x = element_text(size = 7.4, face = 'bold'),
...
(varA_ind_gen_bay_ped1 | varE_ind_gen_bay_ped1 | Here_ind_gen_bay_ped1) / (varA_ind_gen_bay_ped2 | varE_ind_gen_bay_ped2 | Here_ind_gen_bay_ped2) / (varA_ind_gen_bay_ped3 | varE_ind_gen_bay_ped3 | Here_ind_gen_bay_ped3) -> param_Bayes_2
...
(varA_ind_gen_reml_ped1 | varE_ind_gen_reml_ped1 | Here_ind_gen_reml_ped1) / (varA_ind_gen_reml_ped2 | varE_ind_gen_reml_ped2 | Here_ind_gen_reml_ped2) / (varA_ind_gen_reml_ped3 | varE_ind_gen_reml_ped3 | Here_ind_gen_reml_ped3) -> param_reml_2
...
## Precisión de la predición mediante simulación ancestral
