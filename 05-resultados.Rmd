...
No se observó una estructura poblacional clara en los primeros dos componentes principales, según las relaciones genéticas realizadas estimadas en la matriz H (Figuras 5.3 y 5.4). De acuerdo a @cite:69, el hecho de que la mayor parte de la variación total sea explicada por unos pocos valores propios (en este estudio, los primeros diez a veinte valores propios explicaron el 80.0% de la variación total), sugiere que la población no es diversa, lo cual era de esperar dado el método implementado de generación de individuos a través de la simulación del pedigrí ancestral y de descendientes, con el cual se trato de replicar los métodos que en realidad se emplean en la mejora de los cultivos de arroz, esto es, generación inicial sintetizada a partir del cruzamiento entre distintos individuos, y posterior recombinación a través del dialelo circulante en las progenies, en distintas generaciones y por autopolinización. La ausencia de estructura poblacional, según @cite:70, es un escenario favorable para obtener estimaciones confiables de predicción genómica.
...
\noindent
__Figura 5.3:__ Gráfico de sedimentación y de componentes principales de los dos primeros valores propios. Aquí, la matriz H se estimó a partir de 451 individuos genotipados con densidad de marcador aproximada de 1.000, 10.000 y 100.000, y en el pedigrí 1 (primera replica) mediante simulación ancestral.
