...
ggplot(data = param_gen,aes(x = Densidad, y = prom, fill = Ind_gen, colour = Ind_gen)) +
  ...
  geom_errorbar(aes(ymin = prom - des, ymax = prom + des), width = 0.2, position = position_dodge(width = 0.7)) +
  scale_y_continuous(limits = c(0.0, 1.0)) +
  facet_grid(vars(Pedigrí), vars(Enfoque)) +
  labs(y = 'Heredabilidad', x = 'Densidad del marcador') +
