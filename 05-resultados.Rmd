...
::: {.center data-latex=""}
__Tabla 5.1:__ Estimaciones de heredabilidad para el caracter tiempo de floración estimado mediante el método BLUP.
:::
...
:::
<!--
Los resultados del análisis de máxima verosimilitud restringida (REML) y... (RKHS) bajo el modelo aditivo se observan en la Figura 5.2.
-->
