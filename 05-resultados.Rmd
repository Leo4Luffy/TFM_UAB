...
## Estructura poblacional y heredabilidad

No se observó una estuctura poblacional clara en los primeros dos componentes principales, según las relaciones genéticas realizadas estimadas en la matriz H (Figuras 5.3 y 5.4). De acuerdo a @cite:69, el hecho de que la mayor parte de la variación total sea explicada por unos pocos valores propios (en este estudio, el 80.0% de la variación explicada entre los primeros diez a veinte valores propios), sugiere que la población no fue diversa, lo cual era de esperar dado el método implementado de generación de individuos a través de la simulación del pedigrí ancestral y de descendientes, con el cual se trato de replicar los métodos que en realidad se emplean en la mejora de los cultivos de arroz, esto es, generación inicial sintetizada a partir del cruzamiento entre distintos individuos, y posterior recombinanción a través del dialelo circulante en las progenies, en distintas generaciones y por autopolinización. Este hecho de ausencia de estructura poblacional, según @cite:70, sugiere un escenario favorable para obtener estimaciones confiables de predicción genómica.
...
::: {.center data-latex=""}
__Figura 5.3:__ Gráfico de sedimentación y de componentes principales de los dos primeros valores propios. Aquí, la matriz H se estimó a partir de 451 individuos genotipados con densidad de marcador aproximada de 1.000, 10.000 y 100.000, y en el pedigrí 1 (primera replica).
:::
...
::: {.center data-latex=""}
__Figura 5.4:__ Gráfico de sedimentación y de componentes principales de los dos primeros valores propios. Aquí, la matriz H se estimó a partir de 2091 individuos genotipados con densidad de marcador aproximada de 1.000, 10.000 y 100.000, y en el pedigrí 3 (primera replica).
:::
...
::: {.center data-latex=""}
__Figura 5.5:__ Distribuciones posteriores de componentes de varianza y de heredabilidad obtenidas mediante enfoques Bayesianos. Los valores presentados en la Tabla 5.1 (para el enfoque Bayesiano), corresponden a la media calculada a partir de estas distribuciones.
:::

## Precisión de la predición mediante simulación del pedigrí ancestral y de descendientes
