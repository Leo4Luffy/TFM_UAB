...
data.frame(
  ...
  geom_point(aes(x = x, y = y), data = Puntos, size = 11.6, shape = 21, color = 'black', fill = 'black', alpha = 0.4) +
  geom_point(aes(x = x, y = y), data = Cuadros, size = 11.6, shape = 22, color = 'black', fill = 'black', alpha = 0.4) +
