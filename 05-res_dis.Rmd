...
::: {.center data-latex=""}
__Tabla 5.1:__ Estimaciones de heredabilidad para el caracter tiempo de floración estimado por BLUP basado en el pedigrí.
:::
...
tribble(
  ...
  'Heredabilidad', 0.72, 0.78, 0.84, 0.80, 79, 0.84
  ) %>%
  gt() %>%
  cols_label(
    Pedigrí_a = 'Ped. 1',
