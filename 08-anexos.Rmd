...
pacman::p_load(tibble, gt, tidyverse, here, FactoMineR, factoextra)
```
...
## Matriz de parentesco combinada
...
(Graf_val_propio_mH_1 | Graf_PCA_mH_1) / (Graf_val_propio_mH_2 | Graf_PCA_mH_2) / (Graf_val_propio_mH_3 | Graf_PCA_mH_3) #-> Graf_PCA_mH
```
